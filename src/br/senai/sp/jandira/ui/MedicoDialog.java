...
public class MedicoDialog extends javax.swing.JDialog {
    ...
    private void preencherFormulario() {
        ...
        textFieldDataNascimento.setText(medico.getDataNascimento());
        atualizarListaEspecialidades();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/senai/sp/jandira/img/menu-32.png"))); // NOI18N
        jPanel1.add(jLabel4);
        jLabel4.setBounds(40, 30, 40, 30);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(204, 0, 255));
        jLabel1.setText("Médicos - Adicionar");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(110, 20, 336, 48);
        ...
        labelEspecialidadesMedico.setForeground(new java.awt.Color(255, 0, 204));
        labelEspecialidadesMedico.setText("Especialidades do Médico:");
        jPanel2.add(labelEspecialidadesMedico);
        labelEspecialidadesMedico.setBounds(370, 290, 250, 30);

        labelCRM.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        labelCRM.setForeground(new java.awt.Color(255, 0, 204));
        ...
        labelNomeMedico.setForeground(new java.awt.Color(255, 0, 204));
        ...
        labelCodigo.setForeground(new java.awt.Color(255, 0, 204));
        ...
        labelEmail.setForeground(new java.awt.Color(255, 0, 204));
        ...
        labelDataNascimento.setForeground(new java.awt.Color(255, 0, 204));
        ...
        labelTelefone1.setForeground(new java.awt.Color(255, 0, 204));
        ...
        labelListaEspecialidades.setForeground(new java.awt.Color(255, 0, 204));
        labelListaEspecialidades.setText("Lista de Especialidades:");
        jPanel2.add(labelListaEspecialidades);
        labelListaEspecialidades.setBounds(40, 290, 250, 30);
        ...
        jPanel2.setBounds(0, 80, 880, 660);

        setBounds(0, 0, 896, 744);
    ...
    private void atualizar() {
        ...
        medico.setDataNascimento(textFieldDataNascimento.getText());
    ...
    private boolean validarCadastro() {
        ...
        System.out.println(textFieldDataNascimento.getText().length());
        ...
        if (textFieldDataNascimento.getText().equals("##/##/####") == true) {
            JOptionPane.showMessageDialog(this, "Por favor, preencha a data de nascimento do Médico!", "Médico", JOptionPane.ERROR_MESSAGE);
            textFieldDataNascimento.requestFocus();
            return false;
        }
...
//            JOptionPane.showMessageDialog(this, "Adicione a data", "Médico", JOptionPane.INFORMATION_MESSAGE);
//        }
        return true;
    }
...
//    private boolean verificarDataNascimento() {
//        try {
//            medico.setDataNascimento(textFieldDataNascimento.getText());
//        } catch (DateTimeParseException e) {
//            JOptionPane.showMessageDialog(this, "Adicione a data", "Médico", JOptionPane.INFORMATION_MESSAGE);
